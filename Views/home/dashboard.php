...
<div class="dashboard-header">
    <h1 class="dashboard-title"><i class="fa-solid fa-chart-line"></i> Dashboard - DevolutionSync</h1>
    ...
    <div class="current-date">
        <strong><i class="fa-solid fa-calendar-day"></i> Mostrando datos para:</strong>
...
<div class="indicators-grid">
    ...
    <div class="indicator-card border-blue">
        ...
        <div class="indicator-icon"><i class="fa-solid fa-boxes-stacked"></i></div>
    ...
    <div class="indicator-card border-teal">
        <div class="indicator-icon"><i class="fa-solid fa-rotate"></i></div>
    ...
    <div class="indicator-card border-purple">
        <div class="indicator-icon"><i class="fa-solid fa-circle-plus"></i></div>
    ...
    <div class="indicator-card border-green">
        <div class="indicator-icon"><i class="fa-solid fa-scale-balanced"></i></div>
    ...
    <div class="indicator-card border-orange">
        <div class="indicator-icon"><i class="fa-solid fa-cubes"></i></div>
...
<div class="general-stats">
    <h3><i class="fa-solid fa-clipboard-list"></i> Estado de Devoluciones — <?php echo date('d/m/Y', strtotime($fechaFiltro)); ?></h3>
    <div class="stats-grid">
        ...
        <div class="stat-item">
            ...
            <div class="stat-label"><i class="fa-solid fa-circle-check"></i> Aprobadas</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo $statsHoy['rechazados'] ?? 0; ?></div>
            <div class="stat-label"><i class="fa-solid fa-circle-xmark"></i> Rechazadas</div>
        </div>
        <div class="stat-item">
            ...
            <div class="stat-label"><i class="fa-solid fa-chart-pie"></i> Revisadas</div>
        </div>
    </div>
</div>
...
<div class="general-stats">
    <h3><i class="fa-solid fa-globe"></i> Resumen General (Todas las Fechas)</h3>
    <div class="stats-grid">
        <div class="stat-item">
            <div class="stat-value"><?php echo $statsGeneral['total'] ?? 0; ?></div>
            <div class="stat-label"><i class="fa-solid fa-boxes-stacked"></i> Total Devoluciones</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo $statsGeneral['aprobados'] ?? 0; ?></div>
            <div class="stat-label"><i class="fa-solid fa-circle-check"></i> Total Aprobadas</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo $statsGeneral['rechazados'] ?? 0; ?></div>
            <div class="stat-label"><i class="fa-solid fa-circle-xmark"></i> Total Rechazadas</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo $statsGeneral['pendientes'] ?? 0; ?></div>
            <div class="stat-label"><i class="fa-solid fa-hourglass-half"></i> Total Pendientes</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo number_format($statsGeneral['total_kg'] ?? 0, 2); ?></div>
            <div class="stat-label"><i class="fa-solid fa-weight-hanging"></i> Total KG General</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo number_format($statsGeneral['total_und'] ?? 0, 0); ?></div>
            <div class="stat-label"><i class="fa-solid fa-cubes"></i> Total UND General</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo count($fechas); ?></div>
            <div class="stat-label"><i class="fa-solid fa-calendar-check"></i> Dias con Actividad</div>
        </div>
    </div>
</div>
