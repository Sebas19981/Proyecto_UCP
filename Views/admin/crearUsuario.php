                                ...
                                <?php
                                    ...
                                    switch ($grado) {
                                        case 1:
                                            ...
                                            $rolClase = 'background:#f8d7da; color:#721c24;';
                                            $rolIcono = '🔴';
                                            break;
                                        case 2:
                                            $rolTexto = 'Auxiliar';
                                            $rolClase = 'background:#fff3cd; color:#856404;';
                                            $rolIcono = '🟡';
                                            break;
                                        case 3:
                                            $rolTexto = 'Consulta';
                                            $rolClase = 'background:#d1e7dd; color:#0f5132;';
                                            $rolIcono = '🟢';
                                            break;
                                        default:
                                            $rolTexto = 'Desconocido';
                                            $rolClase = 'background:#e9ecef; color:#495057;';
                                            $rolIcono = '⚪';
                                            break;
                                    }
                                ?>
...
document.querySelectorAll('input[style*="uppercase"]').forEach(function(input) {
