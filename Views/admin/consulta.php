        ...
        <div class="admin-stats">
            ...
            <div class="stat-badge stat-pending">
                <span class="stat-number">
                    <?php echo count(array_filter($devoluciones, function($d) { return strtolower($d['estado']) === 'pendiente'; })); ?>
                </span>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    switch ($motivo) {
                                        case 'devolucion':
                                            $motivoClase = 'motivo-devolucion';
                                            $motivoIcono = '🔄';
                                            break;
                                        case 'faltante':
                                            $motivoClase = 'motivo-faltante';
                                            $motivoIcono = '❌';
                                            break;
                                        case 'sobrante':
                                            $motivoClase = 'motivo-sobrante';
                                            $motivoIcono = '➕';
                                            break;
                                        default:
                                            $motivoClase = 'motivo-devolucion';
